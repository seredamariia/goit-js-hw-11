import{S as p,i as d}from"./assets/vendor-9310f15c.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?t.credentials="include":e.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=n(e);fetch(e.href,t)}})();const l=document.querySelector(".loader"),i=document.querySelector(".gallery"),f=document.querySelector(".search-form"),m="https://pixabay.com/api/",y="42139525-c14302dd397ed074e72a8f596";f.addEventListener("submit",s=>{s.preventDefault(),i.innerHTML="";const r=s.currentTarget.elements.query.value.trim();if(!r){c();return}l.style.display="block";const n=`${m}?key=${y}&q=${r}&image_type=photo&orientation=horizontal&safesearch=true`;h(n).then(o=>{l.style.display="none",o.hits.length===0?c():(i.innerHTML=g(o.hits),new p(".gallery-item a",{captionDelay:250,captionsData:"alt"}).refresh())}).catch(o=>console.error(o))});function h(s){return fetch(s).then(r=>{if(!r.ok)throw new Error(r.statusText);return r.json()})}function g(s){return s.map(({webformatURL:r,largeImageURL:n,tags:o,likes:e,views:t,comments:a,downloads:u})=>`<li class="gallery-item">
            <a href=${n}> 
